...
public class TablePrint {
    ...
    public void entryInFileTable(double[] resultList, double[] resultSet, int[] options) throws Exception {
        ...
        BufferedWriter out = new BufferedWriter(new FileWriter("src//collection//" + nameFile + ".txt"));
        ...
        for (int i = 0; i < options.length; i++) {
            ...
            out.write("--------------------------------------------------------------------------");
            out.write("\r\n");
            out.write("|" + infoInTable[9] + "   |" + resultSet[i + stepSet] + "|" + " -  " + "|" + resultSet[i + 1 + stepSet] + " |  " + resultSet[i + 2 + stepSet] + "  |  " + resultSet[i + 3 + stepSet] + "  |" + "  -  " + "       |  " + "  -  " + "        |");
            out.write("\r\n");
            out.write("--------------------------------------------------------------------------");
            out.write("\r\n");
            out.write("|" + infoInTable[10] + "   |" + resultSet[i + 4 + stepSet] + "|" + " -  " + "|" + resultSet[i + 5 + stepSet] + " |  " + resultSet[i + 6 + stepSet] + "  |  " + resultSet[i + 7 + stepSet] + "  |" + "  -  " + "       |  " + "  -  " + "        |");
            out.write("\r\n");
            out.write("--------------------------------------------------------------------------");
            out.write("\r\n");
            out.write("\r\n");
    ...
    public void entryPrintTable(double[] resultList, double[] resultSet, int[] options) throws Exception {
        ...
        for (int i = 0; i < options.length; i++) {
            ...
            System.out.println("--------------------------------------------------------------------------");
            System.out.println("|" + infoInTable[9] + "   |" + resultSet[i + stepSet] + "|" + " -  " + "|" + resultSet[i + 1 + stepSet] + " |  " + resultSet[i + 2 + stepSet] + "  |  " + resultSet[i + 3 + stepSet] + "  |" + "  -  " + "       |  " + "  -  " + "        |");
            System.out.println("--------------------------------------------------------------------------");
            System.out.println("|" + infoInTable[10] + "   |" + resultSet[i + 4 + stepSet] + "|" + " -  " + "|" + resultSet[i + 5 + stepSet] + " |  " + resultSet[i + 6 + stepSet] + "  |  " + resultSet[i + 7 + stepSet] + "  |" + "  -  " + "       |  " + "  -  " + "        |");
            System.out.println("--------------------------------------------------------------------------");
            if (i == 1) {
                stepList = 12;
                stepSet = 6;
